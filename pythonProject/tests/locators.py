...
class Locators:
    ...
    SAUCE_SECTION = (By.XPATH, "//span[contains(text(),'Соусы')]")        # Кнопка раздела "Соусы"
    ...
    H2_SAUCES = (By.XPATH, "//h2[contains(text(),'Соусы')]")        #
    H2_BUNS = (By.XPATH, "//h2[contains(text(),'Булки')]")        #
    H2_FILLINGS = (By.XPATH, "//h2[contains(text(),'Начинки')]")        #
